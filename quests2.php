          ...
          <span class="navbar-toggler-icon"></span>
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    ...
                    <div class="navbar-nav ml-auto">
                        <a href="quests2.php" class="p-3 text-decoration-none text-white bold">Challenges</a>
      ...
      echo "Hint-3:$k3";
                ...
                <div class="col-md-4 mb-3">
                    <div class="card category_pwning">
                        <div class="card-header" data-target="#problem_id_13" data-toggle="collapse" aria-expanded="false" aria-controls="problem_id_2">
                            Crack 103
                        </div>
