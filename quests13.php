          ...
          <span class="navbar-toggler-icon"></span>
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    ...
                    <div class="navbar-nav ml-auto">
                        <a href="quests13.php" class="p-3 text-decoration-none text-white bold">Challenges</a>
                    ...
                    <div class="card category_pwning">
                        ...
                        <div id="problem_id_23" class="collapse card-body">
                            <blockquote class="card-blockquote">
                                ...
                                <p> Can you identify which techinical term this picture depicts?</p>
                                <a target="_blank" href="Picture-decode/9.png" style="color:yellow;"><b>Follow me</b></a><br>
                    ...
                    <div class="card category_pwning">
                        ...
                        <div id="problem_id_33" class="collapse card-body">
                            <blockquote class="card-blockquote">
                                ...
                                <p> Can you find the flag? </p>
                                <a target="_blank" href="https://mindmatrix-securepage.netlify.app/" style="color:yellow;"><b>Follow me</b></a><br>
  ...
  if (mysqli_num_rows($result1) > 0) {
    ...
    $row2 = mysqli_fetch_array($result2);
      ...
      echo "hint3:$k3";
                                ...
                                <form action=ans.php method="post">
                                <div class="input-group mt-3">
                                    <input type="text" class="form-control" name="ans" placeholder="Enter Flag" aria-label="Enter Flag" aria-describedby="basic-addon2">
                                    <div class="input-group-append">
                                        <button id="submit_p3" class="btn btn-outline-secondary" type="submit">Go!</button>
                                    </div>
                                </div>
                    ...
                    <div class="card category_misc">
                        ...
                        <div id="problem_id_34" class="collapse card-body">
                            <blockquote class="card-blockquote">
                                ...
                                <p>Hack Secure Page to unlock!</p>
                                <!-- <p> Can you find the flag? </p>
